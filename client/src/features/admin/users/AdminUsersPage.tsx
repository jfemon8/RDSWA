                    ...
                    <td className="p-3">
                      <div className="flex gap-1">
                        {u.membershipStatus === 'pending' && (
                          <>
                            <button onClick={() => approveMutation.mutate(u._id)} title="Approve"
                              className="p-1.5 text-green-600 hover:bg-green-50 dark:hover:bg-green-900/20 rounded">
                              <UserCheck className="h-4 w-4" />
                            </button>
                            <button onClick={() => rejectMutation.mutate(u._id)} title="Reject"
                        ...
                        {u.membershipStatus !== 'suspended' && u.role !== 'super_admin' && (
                          <button onClick={() => suspendMutation.mutate(u._id)} title="Suspend"
