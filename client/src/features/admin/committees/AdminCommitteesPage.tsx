  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={() => { setShowForm(true); setEditId(null); setForm({ name: '', description: '', startDate: '', endDate: '' }); }}
            ...
            <div key={c._id} className="border rounded-lg p-4 bg-background">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-1">
                  <button onClick={() => startEdit(c)} className="p-2 hover:bg-accent rounded" title="Edit">
                    <Pencil className="h-4 w-4" />
                  </button>
                  {c.isCurrent && (
                    <button onClick={() => archiveMutation.mutate(c._id)} className="p-2 hover:bg-accent rounded" title="Archive">
